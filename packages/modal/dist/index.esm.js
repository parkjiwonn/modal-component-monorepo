...
function Modal(_a) {
    ...
    if (!isOpen)
        return null;
    return (jsx("div", __assign({ className: "modal-overlay" }, { children: jsxs("div", __assign({ className: "modal-content enhanced-modal", ref: modalRef, tabIndex: -1 }, { children: [jsxs("div", __assign({ className: "modal-header" }, { children: [jsx("h3", { children: "\uC54C\uB9BC" }), enableKeyboardShortcuts && (jsx("div", __assign({ className: "modal-shortcuts" }, { children: jsx("small", { children: "ESC: \uCDE8\uC18C | Enter: \uD655\uC778" }) })))] })), jsx("div", __assign({ className: "modal-body" }, { children: jsx("p", { children: message }) })), jsxs("div", __assign({ className: "modal-buttons" }, { children: [jsx("button", __assign({ onClick: onConfirm ? onConfirm : undefined, className: "confirm-btn", autoFocus: true }, { children: "\uD655\uC778" })), showCancelButton && (jsx("button", __assign({ onClick: onCancel ? onCancel : undefined, className: "cancel-btn" }, { children: "\uCDE8\uC18C" })))] })), enableOutsideClick && (jsx("div", __assign({ className: "modal-hint" }, { children: jsx("small", { children: "\uBAA8\uB2EC \uC678\uBD80\uB97C \uD074\uB9AD\uD558\uAC70\uB098 ESC\uD0A4\uB97C \uB20C\uB7EC \uB2EB\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4" }) })))] })) })));
}
...
var ModalProvider = function (_a) {
    ...
    var showModal = useCallback(function (message, options) {
        if (options === void 0) { options = {}; }
